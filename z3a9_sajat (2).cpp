...
public:
      ...
      */
 		LZWBinFa () :gyoker ( new Csomopont )
			{
				std::cout << "LZWBinFa ctor" << std::endl;
				fa = gyoker;
			}
		~LZWBinFa ()
			{
...
main ( int argc, char *argv[] )
{
     ...
     kiFile << binFa1;   // ehhez kell a globális operator<< túlterhelése, lásd fentebb
     ...
     LZWBinFa binFa3 = std::move ( binFa1 );
    ...
    */
     ...
     //std::cout << argv_2[2] << std::endl; //lokális változó
